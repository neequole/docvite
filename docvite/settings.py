"""
Django settings for docvite project.
...
SECRET_KEY = 'n0ls%m=iz^ifb-z10l8gmv2samt^thrpc2h=!#nak4%_0@a$^8'
...
WSGI_APPLICATION = 'docvite.wsgi.application'
